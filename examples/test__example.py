"""
The `test__example` module contains example tests for easy reference and copy-pasting.
...
def test__sum_with_parameterization(input_data: list[int], expected_output: int) -> None:
    """
